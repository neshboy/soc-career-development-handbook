...
**[CONCEPT]** Somewhere around senior analyst, the SOC Manager's Operating Handbook's own career ladder stops being a single line and forks into three real, named roads: detection engineer, threat hunter, or team lead, plus a fourth, often-unlabeled road that just means staying a strong individual contributor at senior scope. SOC Manager's Operating Handbook, Part 13 — Career Ladders & Promotion Criteria, §3 owns exactly what evidence a promotion committee will demand before certifying you on any of those three named roads — a work-sample bar for detection engineering, a hunt-record bar for hunting, a coaching-aptitude bar for team lead, and (per §3.4) an explicit dual-ladder rung for the fourth, unlabeled road. This part adds a fifth road of its own — incident responder (Part 17) — which has no counterpart in that organizational ladder; Part 13 is silent on it, and this book owns that bar in full rather than citing one. This part does not re-derive any of Part 13's own evidence bars. What it owns is narrower and comes earlier: how you personally decide which road to point a year or more of study time at, before you've built the evidence any of those bars will ask for.
...
**[CONCEPT]** The rest of this book's Section F — Parts 15 through 18 — builds the full study plan, portfolio, and home-lab work for detection engineer and threat hunter, in the same order SOC Manager's Operating Handbook Part 13 §3 presents those two branches so a reader flipping between the two books never has to remap which is "first," plus incident responder — this book's own added track, with no counterpart in that ladder — and staying a strong individual contributor, Part 13 §3.4's unlabeled fourth road. (Part 13 §3's third named branch, team lead, gets its own study plan separately, in this book's Section G.) This part previews those bars just enough to route you toward the right one before you start.
...
**[SENIOR/SPECIALIST]** Three of the four branch bars described below are organizational evaluation mechanics — what a promotion committee will actually check before certifying you on that branch. SOC Manager's Operating Handbook, Part 13 — Career Ladders & Promotion Criteria, §3 owns that mechanic in full for detection engineer, threat hunter, and team lead; §4.3's incident responder bar is this book's own (Part 17), with no promotion-committee counterpart in Part 13. The four short summaries below exist only so the aptitude signals in §2 have a real target to point at, not to re-derive how a committee runs. Read each one as "this is what I'll eventually be scored against," not as a to-do list — Parts 15 through 18 own the to-do list.
...
> **Cross-Book Pointer**
> This part does not explain how a promotion committee is composed, how it calibrates evidence across candidates, or what a detection-as-code review pipeline or a hunt's methodology actually require technically. See SOC Manager's Operating Handbook, Part 13 — Career Ladders & Promotion Criteria for the full committee mechanics and the exact evidence bar for its three named branches (detection engineer, threat hunter, team lead) plus the fourth-road rung (§3.4) — incident responder's bar is this book's own (Part 17), with no Part 13 counterpart — and Detection Engineering Handbook V2, Parts 22 and 34–35 for the technical methodology behind the detection-engineer and threat-hunter bars specifically. Come back here once you understand what you'll eventually be scored against, so this part's aptitude framework routes you toward a bar that's real instead of one you've imagined.
...
![Figure 3.1 — The specialization decision tree: detection engineer, threat hunter, and team lead (Part 13's three named branches), staying a strong individual contributor (Part 13's unlabeled fourth road), and incident responder (this book's own added track).](../assets/diagrams/fig-0301-specialization-decision-tree.svg)

**Figure 3.1 — The specialization decision tree: detection engineer, threat hunter, and team lead (Part 13's three named branches), staying a strong individual contributor (Part 13's unlabeled fourth road), and incident responder (this book's own added track).** *CONCEPTUAL.* Illustrates the self-assessment questions this part uses to route a reader toward a starting hypothesis, not a capture of any individual's actual decision path. Diagram ID `FIG-0301`.
